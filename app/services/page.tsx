...
import { Clock, Heart, Sparkles, Brain, Users } from "lucide-react"
              ...
              return (
                <Card key={service.id} className="overflow-hidden">
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div>
                      <h3 className="font-semibold text-charcoal mb-3">Benefits You May Experience</h3>
                    ...
                    <div className="pt-4 border-t border-beige">
                      <Link href="/appointments">
                        <Button className="bg-gold hover:bg-gold/90 text-cream w-full sm:w-auto cursor-pointer">
                          Book {service.title}
                        </Button>
                      </Link>
                    </div>
            ...
            <Card className="bg-beige/30 border-brand/20">
              <CardContent className="py-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Link href="/contact">
                    <Button variant="outline" className="border-brand text-brand hover:bg-brand/5 bg-transparent cursor-pointer">
                      Ask a Question
                    </Button>
                  </Link>
                </div>
